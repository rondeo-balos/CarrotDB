...
<p><b>CarrotDB</b> is a json-based database management system, it runs on nodejs framework. It is an open source dbms, and because of that it has the capabalities to operate offline which will boost your productivity to the next level.</p>
